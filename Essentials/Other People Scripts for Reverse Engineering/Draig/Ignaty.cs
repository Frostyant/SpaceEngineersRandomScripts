//Ignaty's messed up code


onst float EPSILON = 1f; 
...
bool IsAligned(){ 
	...
	IMyRemoteControl rc = GridTerminalSystem.GetBlockWithName(REMOTE_NAME) as IMyRemoteControl; 
	IMyTextPanel down = GridTerminalSystem.GetBlockWithName(DOWN_BLOCK_NAME) as IMyTextPanel; 
...
void TravelInDirection(Vector3 dir, IMyRemoteControl rc, float distance = 1f){ 
